...
namespace Zen.Barcode
{
    ...
    public class CodePdf417BarcodeDraw : BarcodeDraw
	{
		...
		private WriteableBitmap _outImage;
		...
		/// <returns></returns>
		public override DrawingImage Draw(string text, BarcodeMetrics metrics)
		{
			_text = Filter(text);
			return PaintCode();
		}
		...
		public virtual DrawingImage PaintCode()
		{
		...
		private ImageSource PaintCodeInternal()
		{
